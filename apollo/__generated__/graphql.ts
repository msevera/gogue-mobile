...
export type LectureShortFragment = { __typename?: 'Lecture', id: string, topic?: string | null, title?: string | null, userId: string, emoji?: string | null, audioDuration?: number | null, creationEvent?: { __typename?: 'LectureCreationEvent', name: string } | null, sections: Array<{ __typename?: 'LectureSection', title: string, hasContent: boolean }>, audioPaths?: { __typename?: 'AudioPaths', stream?: string | null, wav?: string | null } | null, metadata?: { __typename?: 'LectureMetadata', id: string, notesCount: number, playbackTimestamp: number } | null } & { ' $fragmentName'?: 'LectureShortFragment' };
