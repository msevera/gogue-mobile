...
export type Lecture = {
  ...
  keyInsights?: Maybe<Array<Scalars['String']['output']>>;
  languageCode?: Maybe<Scalars['String']['output']>;
  metadata?: Maybe<LectureMetadata>;
  overview?: Maybe<Scalars['String']['output']>;
  research?: Maybe<Array<LectureResearchSection>>;
  ...
  user: User;
  userId: Scalars['ID']['output'];
  voiceInstructions?: Maybe<Scalars['String']['output']>;
  workbook?: Maybe<Array<WorkbookTask>>;
  workspace: Workspace;
  workspaceId: Scalars['ID']['output'];
};
...
export type LectureResearchSection = {
  __typename?: 'LectureResearchSection';
...
export type MatchedSourcesInput = {
  input: Scalars['String']['input'];
};
...
export type Mutation = {
  ...
  setPendingLectureShowNotificationAsDone: Lecture;
  setPlaybackTimestamp: LectureMetadata;
  setProfile?: Maybe<User>;
  setStatus: LectureMetadata;
  setTimezone?: Maybe<User>;
  upsertGlimpsesJob: Scalars['Boolean']['output'];
  upsertSources: Scalars['Boolean']['output'];
};
...
export type MutationSetPendingLectureShowNotificationAsDoneArgs = {
  id: Scalars['ID']['input'];
};
...
export type MutationUpsertGlimpsesJobArgs = {
  id: Scalars['ID']['input'];
};


export type MutationUpsertSourcesArgs = {
  input: Array<UpsertSource>;
};
...
export type Query = {
  ...
  pendingLectureShowNotification?: Maybe<Lecture>;
  signIn?: Maybe<User>;
  sourcesMatched: SourcesCursor;
  user?: Maybe<User>;
};
...
export type QueryLectureBySlugArgs = {
...
export type QuerySourcesMatchedArgs = {
  input?: InputMaybe<MatchedSourcesInput>;
  pagination?: InputMaybe<PaginationInput>;
};
...
export type Source = {
  ...
  internalDescriptionEmbeddings?: Maybe<Array<Scalars['Float']['output']>>;
  keyInsights?: Maybe<Array<Scalars['String']['output']>>;
  keyTakeaways?: Maybe<Array<Scalars['String']['output']>>;
  overview?: Maybe<Scalars['String']['output']>;
  sections?: Maybe<Array<SourceSection>>;
  title: Scalars['String']['output'];
  topic?: Maybe<Scalars['String']['output']>;
};
...
export type SourcesCursor = {
  __typename?: 'SourcesCursor';
  items: Array<Source>;
  pageInfo?: Maybe<PageInfo>;
};
...
export type UpsertSource = {
  ...
  sections?: InputMaybe<Array<UpsertSourceSection>>;
  title: Scalars['String']['input'];
  topic?: InputMaybe<Scalars['String']['input']>;
};

export type UpsertSourceSection = {
  overview?: InputMaybe<Scalars['String']['input']>;
  title: Scalars['String']['input'];
};
...
export type WorkbookTask = {
  __typename?: 'WorkbookTask';
  expectedFormat?: Maybe<Scalars['String']['output']>;
...
export type LectureListItemFragment = { __typename?: 'Lecture', id: string, slug?: string | null, topic?: string | null, title?: string | null, userId: string, emoji?: string | null, creationEvent?: { __typename?: 'LectureCreationEvent', name: string, showNotification?: boolean | null } | null, research?: Array<{ __typename?: 'LectureResearchSection', title: string, hasContent: boolean }> | null, sections: Array<{ __typename?: 'LectureSection', title: string, hasContent: boolean }>, audio?: { __typename?: 'Audio', stream?: string | null, wav?: string | null, duration?: number | null, bars?: Array<number> | null } | null, metadata?: (
    { __typename?: 'LectureMetadata' }
...
export type LecturePreviewFragment = (
  { __typename?: 'Lecture', overview?: string | null, sections: Array<{ __typename?: 'LectureSection', title: string, overview?: string | null, annotations?: Array<{ __typename?: 'LectureSectionAnnotation', title: string, url: string }> | null }>, research?: Array<{ __typename?: 'LectureResearchSection', annotations?: Array<{ __typename?: 'LectureSectionAnnotation', title: string, url: string }> | null }> | null, categories?: Array<{ __typename?: 'LectureCategory', category: { __typename?: 'Category', id: string, name: string } }> | null, source?: { __typename?: 'Source', id: string, title: string, overview?: string | null, topic?: string | null, authors?: Array<string> | null, image?: { __typename?: 'SourceImage', url?: string | null, color?: string | null, width?: number | null, height?: number | null } | null } | null }
...
export type MatchedSourceFragment = { __typename?: 'Source', id: string, title: string, topic?: string | null, overview?: string | null, authors?: Array<string> | null, keyInsights?: Array<string> | null, keyTakeaways?: Array<string> | null, image?: { __typename?: 'SourceImage', url?: string | null, color?: string | null, width?: number | null, height?: number | null } | null, sections?: Array<{ __typename?: 'SourceSection', title: string, overview?: string | null }> | null } & { ' $fragmentName'?: 'MatchedSourceFragment' };

export type AuthUserFragment = { __typename?: 'User', id: string, firstName: string, lastName?: string | null, email: string, pfp?: string | null, phone?: string | null, workspaces: Array<{ __typename?: 'WorkspaceItem', workspaceId: string }>, topics: Array<{ __typename?: 'UserTopic', id: string, name: string }> } & { ' $fragmentName'?: 'AuthUserFragment' };

export type UserFragment = { __typename?: 'User', id: string, firstName: string, lastName?: string | null, pfp?: string | null } & { ' $fragmentName'?: 'UserFragment' };

export type GetGlimpseLatestQueryVariables = Exact<{ [key: string]: never; }>;


export type GetGlimpseLatestQuery = { __typename?: 'Query', glimpsesLatest: { __typename?: 'GlimpsesCursor', items: Array<{ __typename?: 'Glimpse', id: string, topicId: string, content: string, query?: string | null, viewed: boolean, annotations?: Array<{ __typename?: 'GlimpseAnnotation', title?: string | null, url: string, startIndex: number, endIndex: number }> | null }>, pageInfo?: { __typename?: 'PageInfo', next?: number | null } | null } };
...
export type GetLectureDetailsQuery = { __typename?: 'Query', lectureBySlug?: (
    { __typename?: 'Lecture' }
...
export type GetLecturePreviewQuery = { __typename?: 'Query', lectureBySlug?: (
    { __typename?: 'Lecture' }
...
export type GetPendingLectureShowNotificationQueryVariables = Exact<{ [key: string]: never; }>;


export type GetPendingLectureShowNotificationQuery = { __typename?: 'Query', pendingLectureShowNotification?: (
    { __typename?: 'Lecture' }
    & { ' $fragmentRefs'?: { 'LectureListItemFragment': LectureListItemFragment } }
  ) | null };

export type SetPendingLectureShowNotificationAsDoneMutationVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type SetPendingLectureShowNotificationAsDoneMutation = { __typename?: 'Mutation', setPendingLectureShowNotificationAsDone: (
    { __typename?: 'Lecture' }
    & { ' $fragmentRefs'?: { 'LectureListItemFragment': LectureListItemFragment } }
  ) };
...
export type GetMatchedSourcesQueryVariables = Exact<{
  input?: InputMaybe<MatchedSourcesInput>;
  pagination?: InputMaybe<PaginationInput>;
}>;


export type GetMatchedSourcesQuery = { __typename?: 'Query', sourcesMatched: { __typename?: 'SourcesCursor', items: Array<(
      { __typename?: 'Source' }
      & { ' $fragmentRefs'?: { 'MatchedSourceFragment': MatchedSourceFragment } }
    )>, pageInfo?: { __typename?: 'PageInfo', next?: number | null } | null } };
...
export const MatchedSourceFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"MatchedSource"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Source"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"topic"}},{"kind":"Field","name":{"kind":"Name","value":"overview"}},{"kind":"Field","name":{"kind":"Name","value":"image"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"color"}},{"kind":"Field","name":{"kind":"Name","value":"width"}},{"kind":"Field","name":{"kind":"Name","value":"height"}}]}},{"kind":"Field","name":{"kind":"Name","value":"sections"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"overview"}}]}},{"kind":"Field","name":{"kind":"Name","value":"authors"}},{"kind":"Field","name":{"kind":"Name","value":"keyInsights"}},{"kind":"Field","name":{"kind":"Name","value":"keyTakeaways"}}]}}]} as unknown as DocumentNode<MatchedSourceFragment, unknown>;
...
export const GetLectureDetailsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetLectureDetails"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"slug"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"lectureBySlug"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"slug"},"value":{"kind":"Variable","name":{"kind":"Name","value":"slug"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"LectureDetails"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"LectureMetadata"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LectureMetadata"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"notesCount"}},{"kind":"Field","name":{"kind":"Name","value":"playbackTimestamp"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"addedToLibrary"}},{"kind":"Field","name":{"kind":"Name","value":"addedToLibraryAt"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"LectureListItem"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Lecture"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"topic"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"userId"}},{"kind":"Field","name":{"kind":"Name","value":"emoji"}},{"kind":"Field","name":{"kind":"Name","value":"creationEvent"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"showNotification"}}]}},{"kind":"Field","name":{"kind":"Name","value":"research"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"hasContent"}}]}},{"kind":"Field","name":{"kind":"Name","value":"sections"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"hasContent"}}]}},{"kind":"Field","name":{"kind":"Name","value":"audio"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"stream"}},{"kind":"Field","name":{"kind":"Name","value":"wav"}},{"kind":"Field","name":{"kind":"Name","value":"duration"}},{"kind":"Field","name":{"kind":"Name","value":"bars"}}]}},{"kind":"Field","name":{"kind":"Name","value":"metadata"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"LectureMetadata"}}]}},{"kind":"Field","name":{"kind":"Name","value":"image"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"webp"}},{"kind":"Field","name":{"kind":"Name","value":"color"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"LectureDetails"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Lecture"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"LectureListItem"}},{"kind":"Field","name":{"kind":"Name","value":"sections"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"content"}},{"kind":"Field","name":{"kind":"Name","value":"annotations"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"startIndex"}},{"kind":"Field","name":{"kind":"Name","value":"endIndex"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"aligners"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"mfa"}}]}},{"kind":"Field","name":{"kind":"Name","value":"audio"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"stream"}},{"kind":"Field","name":{"kind":"Name","value":"wav"}},{"kind":"Field","name":{"kind":"Name","value":"duration"}},{"kind":"Field","name":{"kind":"Name","value":"bars"}}]}}]}}]} as unknown as DocumentNode<GetLectureDetailsQuery, GetLectureDetailsQueryVariables>;
export const GetLecturePreviewDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetLecturePreview"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"slug"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"lectureBySlug"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"slug"},"value":{"kind":"Variable","name":{"kind":"Name","value":"slug"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"LecturePreview"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"LectureMetadata"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LectureMetadata"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"notesCount"}},{"kind":"Field","name":{"kind":"Name","value":"playbackTimestamp"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"addedToLibrary"}},{"kind":"Field","name":{"kind":"Name","value":"addedToLibraryAt"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"LectureListItem"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Lecture"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"topic"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"userId"}},{"kind":"Field","name":{"kind":"Name","value":"emoji"}},{"kind":"Field","name":{"kind":"Name","value":"creationEvent"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"showNotification"}}]}},{"kind":"Field","name":{"kind":"Name","value":"research"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"hasContent"}}]}},{"kind":"Field","name":{"kind":"Name","value":"sections"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"hasContent"}}]}},{"kind":"Field","name":{"kind":"Name","value":"audio"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"stream"}},{"kind":"Field","name":{"kind":"Name","value":"wav"}},{"kind":"Field","name":{"kind":"Name","value":"duration"}},{"kind":"Field","name":{"kind":"Name","value":"bars"}}]}},{"kind":"Field","name":{"kind":"Name","value":"metadata"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"LectureMetadata"}}]}},{"kind":"Field","name":{"kind":"Name","value":"image"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"webp"}},{"kind":"Field","name":{"kind":"Name","value":"color"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"LecturePreview"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Lecture"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"LectureListItem"}},{"kind":"Field","name":{"kind":"Name","value":"overview"}},{"kind":"Field","name":{"kind":"Name","value":"sections"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"overview"}},{"kind":"Field","name":{"kind":"Name","value":"annotations"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"url"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"research"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"annotations"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"url"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"categories"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"category"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"source"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"image"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"color"}},{"kind":"Field","name":{"kind":"Name","value":"width"}},{"kind":"Field","name":{"kind":"Name","value":"height"}}]}},{"kind":"Field","name":{"kind":"Name","value":"overview"}},{"kind":"Field","name":{"kind":"Name","value":"topic"}},{"kind":"Field","name":{"kind":"Name","value":"authors"}}]}}]}}]} as unknown as DocumentNode<GetLecturePreviewQuery, GetLecturePreviewQueryVariables>;
...
export const GetPendingLectureShowNotificationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetPendingLectureShowNotification"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"pendingLectureShowNotification"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"LectureListItem"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"LectureMetadata"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LectureMetadata"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"notesCount"}},{"kind":"Field","name":{"kind":"Name","value":"playbackTimestamp"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"addedToLibrary"}},{"kind":"Field","name":{"kind":"Name","value":"addedToLibraryAt"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"LectureListItem"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Lecture"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"topic"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"userId"}},{"kind":"Field","name":{"kind":"Name","value":"emoji"}},{"kind":"Field","name":{"kind":"Name","value":"creationEvent"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"showNotification"}}]}},{"kind":"Field","name":{"kind":"Name","value":"research"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"hasContent"}}]}},{"kind":"Field","name":{"kind":"Name","value":"sections"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"hasContent"}}]}},{"kind":"Field","name":{"kind":"Name","value":"audio"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"stream"}},{"kind":"Field","name":{"kind":"Name","value":"wav"}},{"kind":"Field","name":{"kind":"Name","value":"duration"}},{"kind":"Field","name":{"kind":"Name","value":"bars"}}]}},{"kind":"Field","name":{"kind":"Name","value":"metadata"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"LectureMetadata"}}]}},{"kind":"Field","name":{"kind":"Name","value":"image"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"webp"}},{"kind":"Field","name":{"kind":"Name","value":"color"}}]}}]}}]} as unknown as DocumentNode<GetPendingLectureShowNotificationQuery, GetPendingLectureShowNotificationQueryVariables>;
export const SetPendingLectureShowNotificationAsDoneDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SetPendingLectureShowNotificationAsDone"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"setPendingLectureShowNotificationAsDone"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"LectureListItem"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"LectureMetadata"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LectureMetadata"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"notesCount"}},{"kind":"Field","name":{"kind":"Name","value":"playbackTimestamp"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"addedToLibrary"}},{"kind":"Field","name":{"kind":"Name","value":"addedToLibraryAt"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"LectureListItem"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Lecture"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"topic"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"userId"}},{"kind":"Field","name":{"kind":"Name","value":"emoji"}},{"kind":"Field","name":{"kind":"Name","value":"creationEvent"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"showNotification"}}]}},{"kind":"Field","name":{"kind":"Name","value":"research"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"hasContent"}}]}},{"kind":"Field","name":{"kind":"Name","value":"sections"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"hasContent"}}]}},{"kind":"Field","name":{"kind":"Name","value":"audio"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"stream"}},{"kind":"Field","name":{"kind":"Name","value":"wav"}},{"kind":"Field","name":{"kind":"Name","value":"duration"}},{"kind":"Field","name":{"kind":"Name","value":"bars"}}]}},{"kind":"Field","name":{"kind":"Name","value":"metadata"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"LectureMetadata"}}]}},{"kind":"Field","name":{"kind":"Name","value":"image"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"webp"}},{"kind":"Field","name":{"kind":"Name","value":"color"}}]}}]}}]} as unknown as DocumentNode<SetPendingLectureShowNotificationAsDoneMutation, SetPendingLectureShowNotificationAsDoneMutationVariables>;
...
export const GetMatchedSourcesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetMatchedSources"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"MatchedSourcesInput"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"pagination"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"PaginationInput"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"sourcesMatched"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}},{"kind":"Argument","name":{"kind":"Name","value":"pagination"},"value":{"kind":"Variable","name":{"kind":"Name","value":"pagination"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"MatchedSource"}}]}},{"kind":"Field","name":{"kind":"Name","value":"pageInfo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"next"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"MatchedSource"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Source"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"topic"}},{"kind":"Field","name":{"kind":"Name","value":"overview"}},{"kind":"Field","name":{"kind":"Name","value":"image"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"color"}},{"kind":"Field","name":{"kind":"Name","value":"width"}},{"kind":"Field","name":{"kind":"Name","value":"height"}}]}},{"kind":"Field","name":{"kind":"Name","value":"sections"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"overview"}}]}},{"kind":"Field","name":{"kind":"Name","value":"authors"}},{"kind":"Field","name":{"kind":"Name","value":"keyInsights"}},{"kind":"Field","name":{"kind":"Name","value":"keyTakeaways"}}]}}]} as unknown as DocumentNode<GetMatchedSourcesQuery, GetMatchedSourcesQueryVariables>;
